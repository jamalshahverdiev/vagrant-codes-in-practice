...
yum -y install epel-release && yum -y install bash-completion net-tools bind-utils wget telnet vim expect gcc-c++ make jq unzip nfs-utils git java-1.8.0-openjdk.x86_64 java-1.8.0-openjdk-devel.x86_64
